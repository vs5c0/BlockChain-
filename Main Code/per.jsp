  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> </span></h2>
          <h2><span>Authorize Blood Donors </span></h2>
          <p>&nbsp;</p>
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              ...
              <td width="183"><div align="center" class="style21"><span class="style23">Hosp   Name </span></div></td>
	...
	String bname=String.valueOf(application.getAttribute("bank_name"));
	String query1="select * from hosp_log"; 
	...
	s2=rs1.getString(2);
      		...
      		String query="select * from bank_log where name='"+bname+"' "; 
	...
	while ( rs.next() )
	   {
		...
		%>
              <td><div>
                  <div align="center"><a href="per_status_insert.jsp?id=<%=i%>"><%=s9%></a></div>
              </div></td>
              <%
...
%>
          ...
          <p>&nbsp;</p>
          <p align="left"><a href="bank_main.jsp" class="style24">Back</a></p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li>
              <div align="justify"><a href="bank_main.jsp">Blood Bankers </a></div>
            </li>
            <li> 

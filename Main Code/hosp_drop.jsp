    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="hosp_dropinsert.jsp">
            <p class="style24">Welcome to Donor </p>
            <div align="center">
              <table width="427" height="239" border="2" cellpadding="2" cellspacing="2">
                <tr>
                  <th width="207" scope="row"><label><strong class="odd style3 style10">
                    <%
			String bank_name=(String)application.getAttribute("hosp_name");
		...
		String str="select * from hosp_log";
		ResultSet rs= connection.createStatement().executeQuery(str);

		%>
                  Hospital  Name </strong></label>
                      <label></label></th>
...
{%>
                ...
                <tr>
                  <th scope="row">Enter Your Blood Group </th>
                ...
                <tr>
                  <th scope="row">Enter Your Mobile Number </th>
                  <td><input type="text" value="<%out.print(mno);%>"  name="mobile" /></td>
                </tr>
                <tr>
                  <th scope="row">Enter Your Email-id</th>
                  <td><input type="text" value="<%out.print(email);%>"  name="email" /></td>
                </tr>
                <tr>
                  <th height="51" scope="row">Enter Your Address </th>
              ...
              <p align="left"><a href="donor_main.jsp">Back</a></p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li>
              <div align="justify"><a href="donor_main.jsp">Blood Donor </a></div>
            </li>
            <li> 

    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="mainbar">
            <div class="article">
              <h2><span> Blood Donor Login </span></h2>
              <p>&nbsp;</p>
              <form action="donor_authn.jsp" method="post" id="leavereply">
                <label for="name"> Name (required)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; </label>
                <input name="name" type="text" class="box" id="name" value="" />
                <label for="email"><br />
                <br />
                  Password (required) &nbsp;&nbsp; </label>
                <input type="password" id="pass" name="password" class="box" />
                <p>&nbsp;</p>
                <p>
                  <input name="" type="submit"  class="LOGIN" id="imageField" value="Login" />
                  <input type="reset" name="imageField" id="imageField"  class="RESET" />
                </p>
                <p>New  Blood Donor? click here to <a href="donor_reg.jsp"> Register</a></p>
              </form>
            </div>
          </div>
          <p>&nbsp;</p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li>
              <div align="justify"><a href="donor_login.jsp">Blood Donor</a></div>
            </li>
            <li></li>
            <li></li>
            <li></li>

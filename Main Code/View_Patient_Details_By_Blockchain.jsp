...
<div class="header">
  ...
  <h2>&nbsp;</h2>
         ...
         <%
						...
						count1=count1+1;
						   	String query="select * from patient_log where hcode = '"+hsign+"' "; 
...
-->
	    ...
	    <table width="601" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
			...
			<h3 align="center">
			  <p align="center" class="style4"><span class="style1">Patient Block Chain ::</span><span class="style5"> <%=s1%></span><br>
		   ...
		   <tr>
              <td rowspan="8" ><div style="margin:10px 13px 10px 13px;" >
                  <input  name="image" type="image" src="patientprofile.jsp?imgid=<%=i%>" style="width:200px; height:230px;" />
              </div></td>
         </tr>
            <tr>
              <td  width="150" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style25 style26" style="margin-left:20px;">Patient Name:</div></td>
            ...
            <tr>
              <td  width="100" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style27" style="margin-left:20px;">Address:</div></td>

  ...
  <div class="content">
      	...
      	try 
	{
		...
		String bname=String.valueOf(application.getAttribute("bank_name"));
           ...
           String query="select * from blood_detail where bank_name='"+bname+"' "; 
	...
	while ( rs.next() )
	   {
		...
		%>
			...
			if(s9.equalsIgnoreCase("waiting"))
			{
				...
				%>
                <td><div align="center"><a href="no_status_insert.jsp?id=<%=i%>&bg=<%=s4%>"><%=s9%></a></div></td>
                <%
...
%>
          ...
          <p class="infopost style1"><a href="bank_main.jsp">Back</a></p>
          <div class="img"></div>
          <div class="clr"></div>
        </div>
        <div class="article">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li> 
              <div align="justify"> <a href="bank_log.jsp"></a>Logout</div>
            </li>
            <li></li>
            <li></li>
            <li></li>

...
try
{
	...
	String query1="update blood_detail set status='"+str+"' where id='"+id+"'";
	...
	PreparedStatement pst=connection.prepareStatement("insert into  available_blood values(?,?)");
...
pst.setString(2,to);
	...
	response.sendRedirect("view_b_donor.jsp");
}
catch(Exception e)
{
out.println(e);

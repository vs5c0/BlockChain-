...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from hosp_log  where name='"+name+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("Hospital Name Already Exits");							
							%>
							<p><a href="hosp_reg.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					PreparedStatement ps=connection.prepareStatement("insert into hosp_log(name,password,address,email,mob,image,status) values(?,?,?,?,?,?,?)");
						ps.setString(1,name);
			...
			%>
			<p><a href="hosp_log.jsp">Back</a>         <a href="index.html">Home</a> </p>

...
<div class="main">
  ...
  <div class="content">
        ...
        <div class="article">
          ...
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              ...
              <td width="183"><div align="center" class="style21"><span class="style23">Blood Donor   Name </span></div></td>
	...
	int i=0,j=0,k=0;
      	try 
	{
      		String query="select * from blood_donor"; 
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td><div align="center"><a href="donor_details.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
		...
		%>
              <td><div>
                  <div align="center"><a href="donor_status_insert.jsp?id=<%=i%>"><%=s5%></a></div>
              </div></td>
              <%
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li>
              <div align="justify"><a href="admin_main.html">Admin</a></div>
            </li>
            <li> 
              <div align="justify"> <a href="AdminLogin.html">Logout</a></div>
            </li>
            <li></li>
            <li></li>
            <li></li>

...
<%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							{
								blood_gp=multi.getParameter(paramname);
							}
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from blood_donor  where name='"+name+"'"; 
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="donor_log.jsp">Back</a>         <a href="index.html">Home</a> </p>
			...
			String h1 = bi1.toString(16);
					...
					PreparedStatement ps=connection.prepareStatement("insert into blood_donor(name,password,blood_gp,address,email,mob,dob,gender,pincode,location,image,status,hcode) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
						ps.setString(1,name);
						ps.setString(2,password);
						ps.setString(3,blood_gp);
			...
			%>
			<p><a href="donor_login.jsp">Back</a>         <a href="index.html">Home</a> </p>

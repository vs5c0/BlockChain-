...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2> <span class="style2">Register Here !!!</span> </h2>
          <p>
            <label for="name"> </label>
          </p>
          <form action="hosp_insert.jsp" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <div class="article">
              <p>
                <label for="name"><span class="style2">Name (required)<br />
                <br />
                </span></label>
                <span class="style2">
              ...
              <p>
                <span class="style2">
                <label for="pic">Select  Picture (required)</label>
                </span>
                <strong>
                <label for="pic"></label>
                </strong>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li>
              <div align="justify"><a href="hosp_log.jsp">Hospitals</a></div>
            </li>
            <li></li>
            <li></li>
            <li></li>

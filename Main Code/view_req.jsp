...
<div class="main">
  ...
  <div class="content">
          ...
          <div align="left">
            <table width="689" border="1" align="right">
              <tr>
                ...
                <td width="87"><div align="center" class="style29">name</div></td>
				...
				<td width="78"><div align="center" class="style29">status1</div></td>
              </tr>
              <%
      	...
      	try 
	{
           ...
           String query="select * from bank_log"; 
	...
	s9=rs.getString(9);
		%>
              <tr>
                ...
                <td height="27"><div align="center"><%=s6%></div></td>
			...
			if(s9.equalsIgnoreCase("request"))
			{
			
		%>
              <td><div>
                  <div align="center"><a href="view_blood_detail.jsp?id=<%=i%>"><%=s9%></a></div>
              </div></td>
              <%

  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> </span></h2>
          <p class="infopost style1">Hospital  Login </p>
          <p class="infopost style1">&nbsp;</p>
          <form action="hosp_authn.jsp"  method="post">
				 <table width="88%">
					  <tr>
						<th width="115" height="52"><span class="style3">  Hospital name</span> <span class=" style2">*</span> </th>
						<td width="260"><input id="name" name="name" type="text" /></td>
					  </tr>
					  <tr>
						<th height="44"><span class="style3">Password</span> <span class=" style2">*</span> </th>
					  ...
					  <tr>
						...
						<td><p>
						  ...
						  <p>New  Blood Bank? click here to <a href="hosp_reg.jsp"> Register</a></p>
						  <p>&nbsp;</p>
						  <p>&nbsp;</p>
						  <p>&nbsp; </p></td>
					  </tr>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li>
              <div align="justify"><a href="#">Hospital</a></div>
            </li>
            <li> 
              <div align="justify"> <a href="#">Logout</a></div>
            </li>
            <li></li>
            <li></li>
            <li></li>

...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style24">Authorize Blood Donors !!! </h2>
          <p>&nbsp;</p>
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              ...
              <td width="183"><div align="center" class="style21"><span class="style23">Blood Bank    Name </span></div></td>
	...
	int i=0,j=0,k=0;
      	try 
	{
      		String query="select * from hosp_log"; 
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td><div align="center"><a href="hosp_details.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
		...
		%>
              <td><div>
                  <div align="center"><a href="hosp_status_insert.jsp?id=<%=i%>"><%=s5%></a></div>
              </div></td>
              <%

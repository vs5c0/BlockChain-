...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style29">Hospital Details !!!  </h2>
          <table width="510" height="311" border="1" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
            <%
						...
						try 
						{
						   	String query="select * from hosp_log where name='"+don+"'"; 
           ...
           <tr>
              <td rowspan="8" ><div style="margin:10px 13px 10px 13px;" >
                  <input  name="image" type="image" src="hospitalprofile.jsp?imgid=<%=i%>" style="width:200px; height:230px;" />
              </div></td>
            </tr>
            <tr>
